...
- output language in simple Chinese

## 📝 任务流程（请严格按步骤执行）

### Step1: Textbook Quality
...
### Step2: Cognitive Scaffolding

在正文之后，提供以下辅助模块以降低认知负荷：

1. **Explain Like I'm 5**：用最通俗的语言，一句话概括这节课解决了什么核心问题。
2. **易混淆点/陷阱预警**：指出初学者最容易误解的地方，并给出正确视角。
3. **学以致用**：指出这个对于目前的实际生活有什么关联（开发工程师职场人），如何应用到实际生活中 （拓宽角度）
4. **核心概念关系图**：用列表或缩进结构，展示核心概念之间的层级或因果关系。

### Step3: Interaction Loop
